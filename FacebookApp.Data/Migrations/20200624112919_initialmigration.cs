        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 6, 24, 14, 29, 18, 891, DateTimeKind.Local).AddTicks(6580))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 6, 24, 14, 29, 18, 883, DateTimeKind.Local).AddTicks(4863)),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
